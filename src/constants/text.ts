...
export const BAR_CODE_CAPTION =
  'Отлично! Чтобы списать баллы, покажите этот бар-код вашему официанту.';
export const CREATE_POST_REGIME_TEXT =
